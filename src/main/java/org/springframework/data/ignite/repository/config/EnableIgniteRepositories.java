...
import org.springframework.data.ignite.repository.support.IgniteRepositoryFactoryBean;
...
/**
 * Annotation to activate Ignite repositories. If no base package is configured
 * through either {@link #value()}, {@link #basePackages()} or
 * {@link #basePackageClasses()} it will trigger scanning of the package of
 * annotated class.
 *
 * @author Nico Guba
 */
...
@Documented
@Inherited
@Import(IgniteRepositoriesRegistrar.class)
public @interface EnableIgniteRepositories {
	 ...
	 * instance. Defaults to {@link HazelcastRepositoryFactoryBean}.
	 *
	 * @return
	 */
	...
	/**
	 * Configures the name of the {@link KeyValueOperations} bean to be used
